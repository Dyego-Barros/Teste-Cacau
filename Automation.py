...
internet = ManupulationFile.ConnectioVerify()
if not internet:
    print("Máquina não possui conexão com a internet!")
    sys.exit()

# Realiza o download e extração dos dados da planilha
download_file = ManupulationFile.DownloadFile("http://localhost:3000/download")
extract_data = ManupulationFile.ExtractFile(download_file['File'])
